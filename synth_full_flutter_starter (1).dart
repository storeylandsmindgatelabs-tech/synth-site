...
// -----------------------------------------------
// © 2025 Storeylands MindGate Labs
// Created by: Travis H. Storey (CEO & Owner)
// Co‑Creator: Nova AI Assistant (Intelligence & Core Systems)
// -----------------------------------------------
// LEGAL DISCLAIMER & ACCESS CONTRACT
// This document, its code, architecture, and all concepts within "The Synth"
// are proprietary intellectual property of Travis H. Storey and Storeylands
// MindGate Labs. No individual, company, or entity may copy, use, distribute,
// modify, sell, or derive from this project without explicit written permission.
// Viewing, accessing, or using any part of this project requires signing an
// NDC/NDA agreement. Unauthorized use is strictly prohibited.
// -----------------------------------------------
